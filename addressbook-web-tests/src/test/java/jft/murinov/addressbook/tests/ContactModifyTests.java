...
public class ContactModifyTests extends TestBase {
    ...
    public void insurePreconditions(){
        ...
        if (app.contact().all().size() == 0){
            app.contact().create(new ContactData()
                            ...
                            .withHomePhone("+74951234567").withMobilePhoneString("+75551234567").withFirstEmail("nickname@mailserver.ru").withGroup("test1")
                    , true);
        }
    }
    ...
    public void testContactModify() {
        ...
        ContactData contact = new ContactData()
                ...
                .withNickname("NicknameModified").withFirstAddress("Address stringModified").withHomePhone("+74957654321").withMobilePhoneString("+75557654321")
